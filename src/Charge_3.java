	...
	public Charge_3() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String sql="insert into PM values ('"+textField.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"','"+age+"','"+textField_4.getText()+"','"+textField_5.getText()+"')";
				try {
