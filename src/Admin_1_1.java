...
class Admin_1_1 {
	...
	public Admin_1_1() {
		JFrame frm=new JFrame("院长账号维护系统");
		frm.setVisible(true);
		frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frm.setBounds(100, 100, 789, 482);
			...
			public void actionPerformed(ActionEvent arg0) {
				if(lblNewLabel.getText().equals("更改")){
				    ...
				    Statement st=null;
		         	...
		         	String sql="update Plogin set pid='"+textField.getText()+"', pwd='"+textField_1.getText()+"' where name='"+textField_2.getText()+"'";
					try {
				...
				if(lblNewLabel.getText().equals("删除")){
					...
					String sql="delete from PLogin where pid='"+textField.getText()+"'";
					try {
						st.executeUpdate(sql);
					} catch (SQLException e) {
						// TODO Auto-generated catch block
				...
				if(lblNewLabel.getText().equals("增加")){
				    ...
				    Statement st=null;
		         	...
		         	String sql_1="select * from PLogin where pid='"+textField.getText()+"'";
		         	try {
		         		...
		         		if(rs.next()){
						    ...
						    Statement s=null;
				         	...
				         	String sql="insert into PLogin values('"+textField.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"')";
							try {
								s.executeUpdate(sql);
							} catch (SQLException e) {
								// TODO Auto-generated catch block
