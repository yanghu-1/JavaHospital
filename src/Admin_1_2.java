...
import java.sql.*;
 ...
 class Admin_1_2 {
	...
	public Admin_1_2() {
		JFrame frm=new JFrame("管理员账号维护系统");
		frm.setVisible(true);
		frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frm.setBounds(100, 100, 804, 466);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		frm.setContentPane(contentPane);
		contentPane.setLayout(null);
		
		JLabel label = new JLabel("\u9662\u957F\u8D26\u53F7");
		label.setFont(new Font("宋体", Font.PLAIN, 18));
		label.setBounds(140, 10, 106, 28);
			...
			public void actionPerformed(ActionEvent arg0) {
				if(lblNewLabel.getText().equals("更改")){
				    ...
				    Statement st=null;
		         	...
		         	String sql="update Alogin set pid='"+textField.getText()+"', pwd='"+textField_1.getText()+"' where name='"+textField_2.getText()+"'";
					try {
				...
				if(lblNewLabel.getText().equals("删除")){
					...
					String sql="delete from ALogin where pid='"+textField.getText()+"'";
					try {
						st.executeUpdate(sql);
					} catch (SQLException e) {
						// TODO Auto-generated catch block
				...
				if(lblNewLabel.getText().equals("增加")){
				    ...
				    Statement st=null;
		         	...
		         	String sql_1="select * from ALogin where pid='"+textField.getText()+"'";
		         	try {
		         		...
		         		if(rs.next()){
						    ...
						    Statement s=null;
				         	...
				         	String sql="insert into ALogin values('"+textField.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"')";
							try {
								s.executeUpdate(sql);
							} catch (SQLException e) {
								// TODO Auto-generated catch block
