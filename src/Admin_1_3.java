...
class Admin_1_3 {
	...
	public Admin_1_3() {
		JFrame frm=new JFrame("医生账号维护系统");
		frm.setVisible(true);
		frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frm.setBounds(100, 100, 794, 494);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		frm.setContentPane(contentPane);
		contentPane.setLayout(null);
		
		JLabel label = new JLabel("\u533B\u751F\u8D26\u53F7");
			...
			public void actionPerformed(ActionEvent arg0) {
				if(lblNewLabel.getText().equals("更改")){
				    ...
				    Statement st=null;
		         	...
		         	String sql="update Dlogin set Did='"+textField.getText()+"', Dpwd='"+textField_1.getText()+"' where name='"+textField_2.getText()+"'";
					try {
				...
				if(lblNewLabel.getText().equals("删除")){
					...
					String sql="delete from DLogin where Did='"+textField.getText()+"'";
					try {
						st.executeUpdate(sql);
					} catch (SQLException e) {
						// TODO Auto-generated catch block
				...
				if(lblNewLabel.getText().equals("增加")){
				    ...
				    Statement st=null;
		         	...
		         	String sql_1="select * from DLogin where Did='"+textField.getText()+"'";
		         	try {
		         		...
		         		if(rs.next()){
						    ...
						    Statement s=null;
				         	...
				         	String sql="insert into DLogin values('"+textField.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"')";
							try {
								s.executeUpdate(sql);
							} catch (SQLException e) {
								// TODO Auto-generated catch block
