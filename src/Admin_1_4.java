...
import java.sql.*;
 ...
 class Admin_1_4 {
	...
	public Admin_1_4() {
		JFrame frm=new JFrame("药师账号维护体统");
		frm.setVisible(true);
		frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frm.setBounds(100, 100, 808, 480);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		frm.setContentPane(contentPane);
		contentPane.setLayout(null);
		
		JLabel label = new JLabel("\u836F\u5E08\u8D26\u53F7");
			...
			public void actionPerformed(ActionEvent arg0) {
				if(lblNewLabel.getText().equals("更改")){
				    ...
				    Statement st=null;
		         	...
		         	String sql="update Mlogin set Mid='"+textField.getText()+"', Mpwd='"+textField_1.getText()+"' where name='"+textField_2.getText()+"'";
					try {
				...
				if(lblNewLabel.getText().equals("删除")){
					...
					String sql="delete from MLogin where Mid='"+textField.getText()+"'";
					try {
						st.executeUpdate(sql);
					} catch (SQLException e) {
						// TODO Auto-generated catch block
				...
				if(lblNewLabel.getText().equals("增加")){
				    ...
				    Statement st=null;
		         	...
		         	String sql_1="select * from MLogin where Mid='"+textField.getText()+"'";
		         	try {
		         		...
		         		if(rs.next()){
						    ...
						    Statement s=null;
				         	...
				         	String sql="insert into MLogin values('"+textField.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"')";
							try {
								s.executeUpdate(sql);
							} catch (SQLException e) {
								// TODO Auto-generated catch block
